...
export const MODULOS = [
  { id: 'inventario', rotulo: 'Inventario' },
  { id: 'ficha-de-base-de-datos', rotulo: 'Ficha de base de datos' },
  { id: 'exigibilidad-rnbd', rotulo: 'Exigibilidad RNBD' },
  { id: 'mapa-de-riesgo', rotulo: 'Mapa de riesgo' },
  { id: 'exportacion', rotulo: 'Exportación' },
] as const;
    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <header className="no-imprimir sticky top-0 z-30 border-b border-borde bg-superficie/92 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-4 gap-y-2 px-4 py-3 sm:px-6">
          <a
            href="https://github.com/AndreZzRg/niand-inventario-bases-datos"
            className="shrink-0"
            aria-label="Repositorio de Inventario de Bases de Datos"
          >
            <Logo alto={28} />
          </a>
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate font-display text-sm font-semibold">
              <span aria-hidden>🗂️ </span>Inventario de Bases de Datos
            </p>
