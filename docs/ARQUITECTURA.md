# Arquitectura — Inventario de Bases de Datos
...
Una carpeta por módulo: `inventario`, `ficha-de-base-de-datos`, `exigibilidad-rnbd`, `mapa-de-riesgo`, `exportacion`.
...
`localStorage` bajo claves con prefijo `niand-inventario-bases-datos:`.
