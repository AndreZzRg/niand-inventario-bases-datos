...
**Registro Nacional de Bases de Datos y gobierno de datos personales**

Laboratorio 08 de la suite de cumplimiento operable de **NiAnd Labs S.A.S.**

[![CI](https://github.com/AndreZzRg/niand-inventario-bases-datos/actions/workflows/ci.yml/badge.svg)](https://github.com/AndreZzRg/niand-inventario-bases-datos/actions/workflows/ci.yml)
[![Pages](https://github.com/AndreZzRg/niand-inventario-bases-datos/actions/workflows/pages.yml/badge.svg)](https://github.com/AndreZzRg/niand-inventario-bases-datos/actions/workflows/pages.yml)
[![CodeQL](https://github.com/AndreZzRg/niand-inventario-bases-datos/actions/workflows/codeql.yml/badge.svg)](https://github.com/AndreZzRg/niand-inventario-bases-datos/actions/workflows/codeql.yml)
...
### [▶ Abrir la aplicación](https://andrezzrg.github.io/niand-inventario-bases-datos/)
...
Inventario de bases de datos personales con clasificación por categorías y datos sensibles, finalidad, encargados, transferencias y transmisiones internacionales, medidas de seguridad y evaluación de exigibilidad del registro ante el RNBD de la Superintendencia de Industria y Comercio.


### Módulos

1. **Inventario**
2. **Ficha de base de datos**
3. **Exigibilidad RNBD**
4. **Mapa de riesgo**
5. **Exportación**
...
```bash
git clone https://github.com/AndreZzRg/niand-inventario-bases-datos.git
cd niand-inventario-bases-datos
npm install
npm run dev
```
...
```bash
# Con GitHub CLI
gh repo create AndreZzRg/niand-inventario-bases-datos --public --source=. --remote=origin --push

# O de forma manual, si ya creó el repositorio vacío en github.com
git remote add origin https://github.com/AndreZzRg/niand-inventario-bases-datos.git
git branch -M main
...
```
https://andrezzrg.github.io/niand-inventario-bases-datos/
```
...
| **Decreto 1074 de 2015** | Arts. 2.2.2.25.1.1 y ss.: reglamentación del RNBD. |
| **Circular Externa 005 de 2017 (SIC)** | Instrucciones sobre el Registro Nacional de Bases de Datos. |
