# Marco normativo — Inventario de Bases de Datos
...
|---|---|---|
| **Ley 1581 de 2012** | Régimen general de protección de datos personales. | 17 sep 2026 |
| **Decreto 1074 de 2015** | Arts. 2.2.2.25.1.1 y ss.: reglamentación del RNBD. | 17 sep 2026 |
| **Circular Externa 005 de 2017 (SIC)** | Instrucciones sobre el Registro Nacional de Bases de Datos. | 17 sep 2026 |
| **Ley 1266 de 2008** | Habeas data financiero. | 17 sep 2026 |
