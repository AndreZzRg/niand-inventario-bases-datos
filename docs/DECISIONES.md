# Registro de decisiones de arquitectura — Inventario de Bases de Datos
...
**Contexto.** GitHub Pages sirve el proyecto bajo `/niand-inventario-bases-datos/`. Fijar esa ruta en la
